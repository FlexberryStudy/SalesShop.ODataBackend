...
namespace IIS.SalesShop
{
    ...
    public class СтрокаПродажи : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.SalesShop.Товар fТовар;
        
        private IIS.SalesShop.Продажа fПродажа;
        ...
        [NotNull()]
        public virtual IIS.SalesShop.Товар Товар
        {
            get
            {
                ...
                IIS.SalesShop.Товар result = this.fТовар;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.SalesShop.Продажа.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.SalesShop.Продажа Продажа
        {
            get
            {
                ...
                IIS.SalesShop.Продажа result = this.fПродажа;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СтрокаПродажиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СтрокаПродажиE", typeof(IIS.SalesShop.СтрокаПродажи));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСтрокаПродажи : ICSSoft.STORMNET.DetailArray
    {
        ...
        //  *** Start programmer edit section *** (IIS.SalesShop.DetailArrayOfСтрокаПродажи members)

        //  *** End programmer edit section *** (IIS.SalesShop.DetailArrayOfСтрокаПродажи members)
        ...
        /// </summary>
        public DetailArrayOfСтрокаПродажи(IIS.SalesShop.Продажа fПродажа) : 
                base(typeof(СтрокаПродажи), ((ICSSoft.STORMNET.DataObject)(fПродажа)))
        {
        }
        
        public IIS.SalesShop.СтрокаПродажи this[int index]
        {
            get
            {
                return ((IIS.SalesShop.СтрокаПродажи)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.SalesShop.СтрокаПродажи dataobject)
        {
