...
ALTER TABLE "Продажа"
	ADD CONSTRAINT "Продажа_FМагаз_412" FOREIGN KEY ("Магазин_m0") REFERENCES "Магазин" ("primaryKey");

CREATE INDEX "Продажа_IМага_1457" on "Продажа" ("Магазин_m0");
