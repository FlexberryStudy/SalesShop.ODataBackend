...
CREATE TABLE [Продажа] (
	 ...
	 [Магазин_m0] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [Продажа] ADD CONSTRAINT [Продажа_FМагазин_0] FOREIGN KEY ([Магазин_m0]) REFERENCES [Магазин]
CREATE INDEX Продажа_IМагазин_m0 on [Продажа] ([Магазин_m0])
